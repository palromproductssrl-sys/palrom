...
export default function Footer() {
  ...
  const t = {
    ...
    copyright: {
      nl: "© 2026 PALROM Products SRL. Alle rechten voorbehouden. Duurzaam geoogst uit lokale Roemeense bossen. (v5.1)",
      en: "© 2026 PALROM Products SRL. All rights reserved. Sustainably harvested from local Romanian forests. (v5.1)",
      de: "© 2026 PALROM Products SRL. Alle Rechte vorbehalten. Nachhaltig geerntet aus lokalen rumänischen Wäldern. (v5.1)",
      ro: "© 2026 PALROM Products SRL. Toate drepturile rezervate. Recoltat în mod durabil din pădurile locale românești. (v5.1)"
    },
    cookiePolicy: {
      nl: "Cookiebeleid",
      en: "Cookie Policy",
